            ...
            <LazyMotion features={domAnimation}>
              ...
              >
                ...
                <div className="block md:hidden absolute z-100 top-0 right-0 w-[100vw] mt-[30vw]">
                  ...
                  <div className="hidden md:block absolute z-100 top-0 right-0 md:bottom-0 w-[100vw] md:w-[38%] xl:w-[26%] 3xl:w-[26%] h-[100vh] overflow-hidden mr-[60px]">
                  ...
                  <article className="flex flex-wrap h-full">
                    ...
                    <div className="2xl:flex 2xl:flex-wrap 2xl:items-end 2xl:w-[68vw] mt-auto relative z-[100]">
