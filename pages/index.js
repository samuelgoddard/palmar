          ...
          <div data-scroll-section>
            <LazyMotion features={domAnimation}>
              <m.div
                ...
                exit="exit"
              >
                <m.main variants={fade} className="p-6 h-screen relative">

                  <div className="hidden md:block absolute z-100 top-0 right-0 bottom-0 w-[100vh] md:h-[40%] xl:h-[33%] 3xl:h-[26%] rotate-90 mt-[37vh] mr-[-40vh]">

                  <div class="relative flex overflow-x-hidden">
                    <div class="animate-marquee whitespace-nowrap flex flex-row space-x-[200px]">
                      <div className="h-full w-[44vh] -rotate-90">
                    ...
                    <div class="absolute top-0 animate-marquee2 whitespace-nowrap flex flex-row space-x-[200px]">
                      <div className="h-full w-[44vh] -rotate-90">
                        <img className="w-full h-full object-cover object-center" src="https://placedog.net/500/640" alt="Dog" />
                      </div>
                      <div className="h-full w-[44vh] -rotate-90">
